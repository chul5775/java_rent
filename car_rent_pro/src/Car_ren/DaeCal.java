...
public class DaeCal extends JPanel implements MouseListener,ActionListener{
...
//		System.out.println(cal.get(Calendar.YEAR)+"  "+cal.get(Calendar.MONTH)+1);
	...
	public static void main(String[] args) {
		DaeCal videocal=new DaeCal();
		JFrame frame=new JFrame("대여일 설정");
	...
	public void actionPerformed(ActionEvent e) {
		...
		CarMain.txtRdaeil.setText(imsis + strban);
		CarMain.calFrame.dispose();
	}
